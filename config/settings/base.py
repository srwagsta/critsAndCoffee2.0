...
ROOT_DIR = environ.Path(__file__) - 3  # (crits_and_coffee/config/settings/base.py - 3 = crits_and_coffee/)
APPS_DIR = ROOT_DIR.path('crits_and_coffee')
...
if READ_DOT_ENV_FILE:
    ...
    env.read_env(str(ROOT_DIR.path('deployment','compose','.env')))
...
MIGRATION_MODULES = {
    'sites': 'crits_and_coffee.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Stephen Wagstaff""", 'srwagsta@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['crits_and_coffee.taskapp.celery.CeleryAppConfig']
if USE_TZ:
